...
public class WaitOrderFragment extends Fragment {
    ...
    private void init(){
        ...
        OrderItem orderItem2 = new OrderItem("111",1,"标题2","内容我是一条内容啊啊啊啊是一条内容啊啊啊啊是一条内容啊啊啊啊是一条内容啊啊啊啊啊啊啊啊2",3.5f, OrderItem.STATE_WAIT_PAY);
        OrderItem orderItem3 = new OrderItem("111",0,"标题3","内容3",3.5f, OrderItem.STATE_CANCEL);
        OrderItem orderItem4 = new OrderItem("111",0,"标题4","内容4",3.5f, OrderItem.STATE_WAIT_PAY);
        OrderItem orderItem5 = new OrderItem("111",1,"标题5","内容5",3.5f, OrderItem.STATE_FINISH_ASSESS);
