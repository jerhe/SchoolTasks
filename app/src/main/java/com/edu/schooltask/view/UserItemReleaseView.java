...
public class UserItemReleaseView extends RelativeLayout {
    ...
    //设置所有信息
    public void setAll(final UserInfoBase user, String releaseTime, String school, String des, boolean event){
    ...
    public void setHead(String userId){
        GlideUtil.setHead(getContext(), userId, headView, false);
    }
