...
public class HttpUtil {
    ...
    public static void getMoney(String id, HttpResponse httpResponse){
        RequestBody requestBody = new FormBody.Builder()
                .add("userid",id).build();
        post(GET_MONEY_URL, requestBody, httpResponse);
    }

    public static void getUserOrder(String id, HttpResponse httpResponse){
        RequestBody requestBody = new FormBody.Builder()
                .add("userid",id).build();
        post(GET_USER_ORDER_URL, requestBody, httpResponse);
    }
